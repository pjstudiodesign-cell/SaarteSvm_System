...
def main():
    ...
    if escolha == "Painel":
        ...
        with st.form("orc_form"):
            ...
            c4, c5, c6 = st.columns(3); prz = c4.text_input("Prazo", "10 dias úteis")
            rev = c5.selectbox("Revisões", ["Padrão", "1", "2", "3", "Ilimitadas"])
            pag = c6.text_input("Pagamento", "50% entrada / 50% entrega")
